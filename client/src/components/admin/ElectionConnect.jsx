...
import { GET_PARTYCONNECT_PROGRESS, POST_PARTYCONNECT_PROGRESS } from "../../redux_saga/Admin_saga/Admin/PartyConnect/action/action";
import { GET_ELECTION_PROGRESS } from "../../redux_saga/Admin_saga/Admin/Election/action/action";
import { GET_PARTY_PROGRESS } from '../../redux_saga/Admin_saga/Admin/party/action/action';
import Swal from 'sweetalert2';


function ElectionConnect() {
          ...
          <div className="col-3">
            <div className='lshadow'>
              ...
              <div className="last-btn">
                <button type="button" onClick={handleConectParty} className="smoll-btn">Connect Party</button>
              </div>
            </div>
          </div>
        </div>
...
export default ElectionConnect